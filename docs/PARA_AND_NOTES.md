...
An Area can contain Projects and can link to its own folder. Moving a mistaken Project to Areas preserves its related items. A Project assigned to an Area derives that Area automatically rather than storing two potentially conflicting answers.
...
Archive contains finished or inactive Projects, Areas, and Resources. Items can be restored. It is preferable to deleting material that may still be useful.
